...
,	count(max)
{
	...
	const char *windowCmd = "window -wh 200 400 -t \"Prime Numbers\" -in Primes;";

	const char *formCmd = "formLayout";

	const char *listCmd = "textScrollList -a 2;";

	const char *closeCmd = "button -l \"Close\" -c \"deleteUI -window %s;\";";

	const char *attachCmd = "formLayout -edit "
							"-an %s	top "
							"-af %s	bottom 5 "
							"-ap %s	left   0 30 "
							"-ap %s	right  0 70 "
	...
	const char *showCmd = "showWindow %s;";
