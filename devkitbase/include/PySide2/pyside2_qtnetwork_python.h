...
enum : int {
    ...
    SBK_QNETWORKACCESSMANAGER_NETWORKACCESSIBILITY_IDX       = 46,
    ...
    SBK_QNETWORKCONFIGURATION_TYPE_IDX                       = 55,
    SBK_QNETWORKCONFIGURATION_PURPOSE_IDX                    = 53,
    SBK_QNETWORKCONFIGURATION_STATEFLAG_IDX                  = 54,
    SBK_QFLAGS_QNETWORKCONFIGURATION_STATEFLAG_IDX           = 23,
    SBK_QNETWORKCONFIGURATION_BEARERTYPE_IDX                 = 52,
    SBK_QNETWORKCONFIGURATION_IDX                            = 51,
    SBK_QNETWORKCONFIGURATIONMANAGER_CAPABILITY_IDX          = 57,
    SBK_QFLAGS_QNETWORKCONFIGURATIONMANAGER_CAPABILITY_IDX   = 24,
    SBK_QNETWORKCONFIGURATIONMANAGER_IDX                     = 56,
    SBK_QNETWORKCOOKIE_RAWFORM_IDX                           = 59,
    SBK_QNETWORKCOOKIE_IDX                                   = 58,
    SBK_QNETWORKCOOKIEJAR_IDX                                = 60,
    SBK_QNETWORKDATAGRAM_IDX                                 = 61,
    SBK_QNETWORKDISKCACHE_IDX                                = 62,
    SBK_QNETWORKINTERFACE_INTERFACEFLAG_IDX                  = 64,
    SBK_QFLAGS_QNETWORKINTERFACE_INTERFACEFLAG_IDX           = 25,
    SBK_QNETWORKINTERFACE_INTERFACETYPE_IDX                  = 65,
    SBK_QNETWORKINTERFACE_IDX                                = 63,
    SBK_QNETWORKPROXY_PROXYTYPE_IDX                          = 68,
    SBK_QNETWORKPROXY_CAPABILITY_IDX                         = 67,
    SBK_QFLAGS_QNETWORKPROXY_CAPABILITY_IDX                  = 26,
    SBK_QNETWORKPROXY_IDX                                    = 66,
    SBK_QNETWORKPROXYFACTORY_IDX                             = 69,
    SBK_QNETWORKPROXYQUERY_QUERYTYPE_IDX                     = 71,
    SBK_QNETWORKPROXYQUERY_IDX                               = 70,
    SBK_QNETWORKREPLY_NETWORKERROR_IDX                       = 73,
    SBK_QNETWORKREPLY_IDX                                    = 72,
    SBK_QNETWORKREQUEST_KNOWNHEADERS_IDX                     = 77,
    SBK_QNETWORKREQUEST_ATTRIBUTE_IDX                        = 75,
    SBK_QNETWORKREQUEST_CACHELOADCONTROL_IDX                 = 76,
    SBK_QNETWORKREQUEST_LOADCONTROL_IDX                      = 78,
    SBK_QNETWORKREQUEST_PRIORITY_IDX                         = 79,
    SBK_QNETWORKREQUEST_REDIRECTPOLICY_IDX                   = 80,
    SBK_QNETWORKREQUEST_TRANSFERTIMEOUTCONSTANT_IDX          = 81,
    SBK_QNETWORKREQUEST_IDX                                  = 74,
    SBK_QNETWORKSESSION_STATE_IDX                            = 84,
    SBK_QNETWORKSESSION_SESSIONERROR_IDX                     = 83,
    SBK_QNETWORKSESSION_USAGEPOLICY_IDX                      = 85,
    SBK_QFLAGS_QNETWORKSESSION_USAGEPOLICY_IDX               = 27,
    SBK_QNETWORKSESSION_IDX                                  = 82,
    SBK_QOCSPRESPONSE_IDX                                    = 87,
    SBK_QtNetworkQPASSWORDDIGESTOR_IDX                       = 89,
    ...
    SBK_QtNetworkQSSL_IDX                                    = 90,
    SBK_QSSLCERTIFICATE_SUBJECTINFO_IDX                      = 99,
    SBK_QSSLCERTIFICATE_PATTERNSYNTAX_IDX                    = 98,
    SBK_QSSLCERTIFICATE_IDX                                  = 97,
    ...
    SBK_QOCSPCERTIFICATESTATUS_IDX                           = 86,
    SBK_QOCSPREVOCATIONREASON_IDX                            = 88,
...
enum : int {
    ...
    SBK_QTNETWORK_QVECTOR_QOCSPRESPONSE_IDX                  = 25, // QVector<QOcspResponse >
