...
enum : int {
    ...
    SBK_QTGUI_QVECTOR_QPOINT_IDX                             = 26, // QVector<QPoint >
    SBK_QTGUI_QVECTOR_QPOINTF_IDX                            = 27, // QVector<QPointF >
    SBK_QTGUI_QVECTOR_QLINE_IDX                              = 28, // const QVector<QLine > &
    SBK_QTGUI_QVECTOR_QLINEF_IDX                             = 29, // const QVector<QLineF > &
    SBK_QTGUI_QVECTOR_QRECT_IDX                              = 30, // const QVector<QRect > &
    SBK_QTGUI_QVECTOR_QRECTF_IDX                             = 31, // const QVector<QRectF > &
    SBK_QTGUI_QLIST_QPOLYGONF_IDX                            = 32, // QList<QPolygonF >
    SBK_QTGUI_QVECTOR_QREAL_IDX                              = 33, // QVector<qreal >
    SBK_QTGUI_QLIST_QPOINT_IDX                               = 34, // const QList<QPoint > &
    SBK_QTGUI_QLIST_QPOINTF_IDX                              = 35, // const QList<QPointF > &
    SBK_QTGUI_QVECTOR_QUINT32_IDX                            = 36, // const QVector<quint32 > &
    SBK_QTGUI_QLIST_QSTANDARDITEMPTR_IDX                     = 37, // const QList<QStandardItem* > &
    SBK_QTGUI_QVECTOR_INT_IDX                                = 38, // const QVector<int > &
    SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                       = 39, // const QHash<int,QByteArray > &
    SBK_QTGUI_QMAP_INT_QVARIANT_IDX                          = 40, // QMap<int,QVariant >
    SBK_QTGUI_QLIST_QPERSISTENTMODELINDEX_IDX                = 41, // const QList<QPersistentModelIndex > &
    SBK_QTGUI_QVECTOR_QTEXTLAYOUT_FORMATRANGE_IDX            = 42, // QVector<QTextLayout::FormatRange >
    SBK_QTGUI_QVECTOR_QTEXTLENGTH_IDX                        = 43, // QVector<QTextLength >
    SBK_QTGUI_QLIST_QTEXTOPTION_TAB_IDX                      = 44, // const QList<QTextOption::Tab > &
    SBK_QTGUI_QLIST_QTEXTBLOCK_IDX                           = 45, // QList<QTextBlock >
    SBK_QTGUI_QVECTOR_QTEXTFORMAT_IDX                        = 46, // QVector<QTextFormat >
    SBK_QTGUI_QLIST_QTEXTFRAMEPTR_IDX                        = 47, // QList<QTextFrame* >
    SBK_QTGUI_QLIST_QTEXTLAYOUT_FORMATRANGE_IDX              = 48, // QList<QTextLayout::FormatRange >
    SBK_QTGUI_QLIST_QREAL_IDX                                = 49, // const QList<qreal > &
    SBK_QTGUI_QLIST_CONSTQTOUCHDEVICEPTR_IDX                 = 50, // QList<const QTouchDevice* >
    SBK_QTGUI_QLIST_QTOUCHEVENT_TOUCHPOINT_IDX               = 51, // const QList<QTouchEvent::TouchPoint > &
